...
from forest.dual_attack.planners import build_c2_experiment
...
if __name__ == "__main__":
    ...
    parser.add_argument('--fixed_attacker_a_source_class', default='dog', type=str,
                        help='Source class held fixed for attacker A while C2 sweeps target geometry.')
    ...
    print(f'Saved C2 experiment spec to {experiment_path}.')
